 ...
 */
/*
 * このファイルには、AT-hd-controllerの幾つかの定義が含まれます。
 * 様々な情報から、幾つかの定義を確認して下さい。(コメントと質問
 * を参照)
 */
#ifndef _HDREG_H
#define _HDREG_H
 ...
 */
/*
 * Ok、hard-disk-typeは現在ハードコードされています。美しくはないです
 * しかし容易です。我々は何の為にBISOを使わないで、どこからHD-Typeを
 * 入手する必要があるのでしょう。これらの値はリファレンスガイドから
 * 得てください。
 */
#define _CYL	1024
#define _HEAD	4
